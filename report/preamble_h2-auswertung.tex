...
\usepackage[ngerman]{babel}                                     %   for German language -- https://www.ctan.org/pkg/babel
...
\usepackage[backend=biber]{biblatex}                           %   for using bibliography, references and citations -- https://ctan.org/pkg/biblatex
