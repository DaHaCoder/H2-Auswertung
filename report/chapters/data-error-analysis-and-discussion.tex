...
Durch den Vergleich mit den Literaturwerten in Tabelle \ref{tab:lit-freq-distance} ergibt sich eine relativ eindeutige Zuordnung für die $5^{2}S_{1/2}$-Zustände, 
\begin{align*}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.8]{figures/plots/PDF/plot-data20-gain30-01-dip-1-rubidium-normalized-fit.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.8]{figures/plots/PDF/plot-data20-gain30-01-dip-2-rubidium-normalized-fit.pdf}
