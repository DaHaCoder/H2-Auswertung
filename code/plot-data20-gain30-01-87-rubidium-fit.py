...
def main():
    ...
    #   ==================================
    p0_1 = [1.0, 0.01127, 0.0000001, 0.084]                           #   I_0, omega_0, gamma, I_y
    t_init_1 = 0.011265
    t_end_1 = 0.011285
    ...
    #   ==================================
    p0_2 = [1.0, 0.011355, 0.0000001, 0.08]                           #   I_0, omega_0, gamma, I_y
    t_init_2 = 0.01135
    t_end_2 = 0.011365
    ...
    #   ==================================
    p0_3 = [1.0, 0.0114, 0.0000001, 0.075]                            #   I_0, omega_0, gamma, I_y
    t_init_3 = 0.011395
    t_end_3 = 0.01141
    ...
    #   ==================================
    p0_4 = [1.0, 0.01147, 0.0000001, 0.071]                           #   I_0, omega_0, gamma, I_y
    t_init_4 = 0.01145
    t_end_4 = 0.01149
    ...
    #   ==================================
    p0_5 = [1.0, 0.011615, 0.0000001, 0.065]                          #   I_0, omega_0, gamma, I_y
    t_init_5 = 0.011605
    t_end_5 = 0.01162
    ...
    fig.savefig("../report/figures/plots/PNG/plot-data20-gain30-01-87-rubidium-fit.png", format = 'png', bbox_inches = 'tight', dpi = 400)
    #fig_i.savefig("../report/figures/plots/EPS/plot-data20-gain30-01-87-rubidium-fit.eps", format = 'eps', bbox_inches = 'tight')
    fig.savefig("../report/figures/plots/PDF/plot-data20-gain30-01-87-rubidium-fit.pdf", format = 'pdf', bbox_inches = 'tight')
    #plt.show()
    #tikzplotlib.save("../report/figures/tikz/plot-data20-gain30-01-87-rubidium-fit.tex")
