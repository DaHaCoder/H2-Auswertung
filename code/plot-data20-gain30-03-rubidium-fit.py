...
def main():
    ...
    #   ==================================
    p0_1 = [0.0000006, 0.015209, 0.0000001, 0.0558]                           #   I_0, omega_0, gamma, I_y
    t_init_1 = 0.01520
    t_end_1 = 0.015218
    ...
    #   ==================================
    p0_2 = [0.000000001, 0.015225, 0.000001, 0.061]                           #   I_0, omega_0, gamma, I_y
    t_init_2 = 0.01522
    t_end_2 = 0.015228
    ...
    #   ==================================
    p0_3 = [0.0000002, 0.015238, 0.000001, 0.061]                             #   I_0, omega_0, gamma, I_y
    t_init_3 = 0.015229
    t_end_3 = 0.0152401
    ...
    #   ==================================
    p0_4 = [0.0000003, 0.0152505, 0.000001, 0.061]                            #   I_0, omega_0, gamma, I_y
    t_init_4 = 0.015243
    t_end_4 = 0.01526
    ...
    #   ==================================
    p0_5 = [0.00001, 0.015277, 0.000001, 0.06]                                #   I_0, omega_0, gamma, I_y
    t_init_5 = 0.015265
    t_end_5 = 0.015285
    ...
    fig.savefig("../report/figures/plots/PNG/plot-data20-gain30-03-rubidium-fit.png", format = 'png', bbox_inches = 'tight', dpi = 400)
    #fig_i.savefig("../report/figures/plots/EPS/plot-data20-gain30-03-rubidium-fit.eps", format = 'eps', bbox_inches = 'tight')
    fig.savefig("../report/figures/plots/PDF/plot-data20-gain30-03-rubidium-fit.pdf", format = 'pdf', bbox_inches = 'tight')
    #plt.show()
    #tikzplotlib.save("../report/figures/tikz/plot-data20-gain30-03-rubidium-fit.tex")
