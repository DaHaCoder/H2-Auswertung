...
def main():
    DATA_DIR = f"../data/data20-gain30-04.csv"
    ...
    ax.add_patch(Rectangle((0.0169, 0.0758), 0.00022, 0.0057, edgecolor = 'tab:orange', facecolor = 'none', linestyle = '--'))
    
    #ax.legend(loc = 'lower left')
    ax.set_xlabel('Zeit $t$ in s')
    ax.set_ylabel('Spannung $U$ in mV')
    ax.set_title(f'Gain30 in dB (04)')
    ax.grid(True)
