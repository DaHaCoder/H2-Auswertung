...
def main():
    ...
    #   ==================================
    p0_1 = [1e-5, 0.016949, 1e-6, 1.0]                             #   I_0, nu_0, gamma, I_y
    t_init_1 = 0.01693
    t_end_1 = 0.01696
    ...
    #   ==================================
    p0_2 = [1e-8, 0.016975, 1e-5, 1.0]                             #   I_0, nu_0, gamma, I_y
    t_init_2 = 0.016968
    t_end_2 = 0.01699
    ...
    #   ==================================
    p0_3 = [1e-5, 0.017008, 1e-6, 1.0]                             #   I_0, nu_0, gamma, I_y
    t_init_3 = 0.0169915
    t_end_3 = 0.01701308
    ...
    #   ==================================
    p0_4 = [1e-5, 0.017026, 1e-6, 1.0]                             #   I_0, nu_0, gamma, I_y
    t_init_4 = 0.017015
    t_end_4 = 0.01705
    ...
    #   ==================================
    p0_5 = [1e-5, 0.017078, 1e-6, 1.0]                             #   I_0, nu_0, gamma, I_y
    t_init_5 = 0.01706
    t_end_5 = 0.01710
    ...
    #   ====================================
    p0 = [-1.0, 0.0170, 1e-6, 0.88]                                #   I_0, nu_0, delta_nu, I_y
    t_init = 0.01665
    t_end = 0.01735
