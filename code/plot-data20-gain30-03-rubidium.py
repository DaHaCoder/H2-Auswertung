...
def main():
    ...
    #   ==================================
    p0_1 = [6e-6, 0.015209, 1e-6, 1.0]                             #   I_0, omega_0, gamma, I_y
    t_init_1 = 0.01520
    t_end_1 = 0.015218
    ...
    #   ==================================
    p0_2 = [1e-8, 0.015225, 1e-5, 1.0]                             #   I_0, omega_0, gamma, I_y
    t_init_2 = 0.01522
    t_end_2 = 0.015228
    ...
    #   ==================================
    p0_3 = [2e-6, 0.015238, 1e-5, 1.0]                             #   I_0, omega_0, gamma, I_y
    t_init_3 = 0.015229
    t_end_3 = 0.0152401
    ...
    #   ==================================
    p0_4 = [3e-6, 0.0152505, 1e-5, 1.0]                            #   I_0, omega_0, gamma, I_y
    t_init_4 = 0.015243
    t_end_4 = 0.01526
    ...
    #   ==================================
    p0_5 = [1e-6, 0.015278, 2e-5, 1.0]                             #   I_0, omega_0, gamma, I_y
    t_init_5 = 0.015265
    t_end_5 = 0.015285
    ...
    #   ====================================
    p0 = [-1.0, 0.01525, 1e-6, 0.9]                                #   I_0, omega_0, delta_omega, I_y
    t_init = 0.0148
    t_end = 0.0157
