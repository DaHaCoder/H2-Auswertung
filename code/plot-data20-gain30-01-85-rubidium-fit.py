...
def main():
    ...
    #   ==================================
    p0_1 = [1.0, 0.012462, 0.0000001, 0.039]                           #   I_0, omega_0, gamma, I_y
    t_init_1 = 0.012455
    t_end_1 = 0.01247
    ...
    #   ==================================
    p0_2 = [1.0, 0.01249, 0.0000001, 0.037]                           #   I_0, omega_0, gamma, I_y
    t_init_2 = 0.012485
    t_end_2 = 0.01250
    ...
    #   ==================================
    p0_3 = [1.0, 0.012518, 0.0000001, 0.0365]                            #   I_0, omega_0, gamma, I_y
    t_init_3 = 0.012505
    t_end_3 = 0.01253
    ...
    #   ==================================
    p0_4 = [1.0, 0.012543, 0.000001, 0.0358]                           #   I_0, omega_0, gamma, I_y
    t_init_4 = 0.012535
    t_end_4 = 0.012555
    ...
    #   ==================================
    p0_5 = [1.0, 0.01259, 0.0000001, 0.0335]                          #   I_0, omega_0, gamma, I_y
    t_init_5 = 0.012585
    t_end_5 = 0.012595
    ...
    fig.savefig("../report/figures/plots/PNG/plot-data20-gain30-01-85-rubidium-fit.png", format = 'png', bbox_inches = 'tight', dpi = 400)
    #fig_i.savefig("../report/figures/plots/EPS/plot-data20-gain30-01-85-rubidium-fit.eps", format = 'eps', bbox_inches = 'tight')
    fig.savefig("../report/figures/plots/PDF/plot-data20-gain30-01-85-rubidium-fit.pdf", format = 'pdf', bbox_inches = 'tight')
    #plt.show()
    #tikzplotlib.save("../report/figures/tikz/plot-data20-gain30-01-85-rubidium-fit.tex")
